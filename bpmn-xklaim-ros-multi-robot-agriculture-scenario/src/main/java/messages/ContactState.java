...
public class ContactState {
	public RosString info;
	public RosString collision1_name;
	public RosString collision2_name;
   ...
   public ContactState(RosString info, RosString collision1_name, RosString collision2_name, Wrench[] wrenches, Wrench total_wrench, Vector3[] contact_positions, Vector3[] contact_normals, double[] depths){
        this.info = info;
